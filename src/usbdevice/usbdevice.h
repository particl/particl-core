...
public:
    ...
    virtual int OpenAsUnlocked() { return 0; }
    virtual int CloseAndReadWhenUnlocked(uint16_t msg_type_out_awaited, uint16_t &msg_type_out, std::vector<uint8_t>& vec_out) { return 0; };
